...
# CODUL TĂU VINE MAI JOS:
text='''Stiati ca dintele lung al narvalului era comercializat de vikingi
în Europa continentală drept corn de inorog
înzestrat cu proprietăți miraculoase?'''
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
fstring=f'His name is {name}! {name} is learing python for Data Science.'
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(len(fstring.split('o')[0]))
# CODUL TĂU VINE MAI SUS:

# Utilizând format string-uri, creează un string care să conțină variabilele `name` și `name2`

# CODUL TĂU VINE MAI JOS:
fstring2=f'His name is {name}! {name2} is learing python for Data Science.'
# CODUL TĂU VINE MAI SUS:
